  ...
  return (
    <section className="w-full text-white">
      <div className="w-full border-b border-[#E4E7E9] bg-[linear-gradient(90deg,#8fa39e_0%,#b4b5af_42%,#c8c9c3_50%,#b4b5af_58%,#8fa39e_100%)]">
        <div className="relative mx-auto min-h-[763px] w-full overflow-visible pb-8 md:min-h-[900px] lg:h-[832px] lg:min-h-0 lg:pb-0 lg:w-[1360px] lg:border-l lg:border-r lg:border-[#E4E7E9]">
          ...
          <div className="relative z-0 mx-auto min-h-[520px] w-full sm:min-h-[580px] lg:h-[594px]">
            <div
            ...
            <div className="absolute inset-x-0 z-20 h-[734px] md:h-[762px] w-full overflow-visible sm:top-6 lg:left-1/2 md:top-[-100px] lg:top-[-140px] lg:h-[734px] lg:w-[732px] lg:-translate-x-1/2 md:overflow-hidden">
              <Image
